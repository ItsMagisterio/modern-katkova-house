      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex justify-between items-start gap-4">
            ...
            <img 
              src={signatureImg} 
              alt="Signature" 
              className="h-16 w-auto opacity-100 hover:opacity-80 transition-opacity mt-8 grayscale-0 contrast-125"
            />
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-border/10">
          <p className="text-foreground/40 text-sm text-center">
            © {new Date().getFullYear()} Каткова Хаус. Все права защищены.
          </p>
        </div>
      </div>
    </footer>
