      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="glass-card p-6 flex items-start gap-4 group hover:scale-[1.02] transition-all duration-300">
              ...
              <div>
                ...
                <a
                  href="https://yandex.by/maps/org/katkova_khaus/204349937274/?ll=39.410179%2C43.851826&utm_source=share&z=17"
                  target="_blank"
          ...
          <div className="flex flex-col gap-6">
            <div className="glass-card overflow-hidden h-80 lg:h-96 relative group">
              <iframe
                src="https://yandex.ru/map-widget/v1/?z=17&ol=biz&oid=204349937274"
                width="100%"
                height="100%"
                frameBorder="0"
