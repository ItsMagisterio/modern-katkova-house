...
const HeroSection = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-10 w-32 h-32 glass-card floating-element opacity-30 hidden lg:block" />
      <div className="absolute bottom-1/3 right-16 w-24 h-24 glass-card floating-element opacity-20 hidden lg:block" style={{ animationDelay: "2s" }} />
      <div className="absolute top-1/2 right-1/4 w-16 h-16 glass-card floating-element opacity-25 hidden lg:block" style={{ animationDelay: "4s" }} />
